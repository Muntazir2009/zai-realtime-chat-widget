<script lang="ts">
  ...
  // Curated GIFs — clean media URLs (no metadata blob in path)
  const trendingGifs = [
    { id: '1', url: 'https://media.giphy.com/media/3o7TKSjRrfIPjeiVyM/giphy.gif', title: 'Thumbs Up' },
    { id: '2', url: 'https://media.giphy.com/media/4NQm2BS9B8MqI/giphy.gif', title: 'Mind Blown' },
    { id: '3', url: 'https://media.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif', title: 'Laugh' },
    { id: '4', url: 'https://media.giphy.com/media/10Jjvi7wEKWbJW/giphy.gif', title: 'Celebrate' },
    { id: '5', url: 'https://media.giphy.com/media/xUA7bdpLxQhsSQdyog/giphy.gif', title: 'Wow' },
    { id: '6', url: 'https://media.giphy.com/media/3o7qE1YN7aBOFPRw8E/giphy.gif', title: 'Dance' },
    { id: '7', url: 'https://media.giphy.com/media/26u4cqiYI30juCOGY/giphy.gif', title: 'Love' },
    { id: '8', url: 'https://media.giphy.com/media/l2YWypohz33wJR3C8/giphy.gif', title: 'Sad' },
  ];
